...
Чтобы не проводить вычисления в нецелых числах и приводить их к целым, будем считать значения в отрезке [0; 255]. После вычисления каждой из компонент цвета пикселя (R, G, B) следует провести целочисленное деление на 256.

Вычисления проводятся в 16-битных числах. Деление на 256 равносильно побитовому сдвигу на 8 бит вправо. Подробно рассмотреть этот переход можно в исходниках.
